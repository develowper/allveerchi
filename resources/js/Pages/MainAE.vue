<template>
  <Scaffold>
    ...
    <div v-if="true">
      <div
          class="relative    bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-secondary-700 to-secondary-900">
        <!--Hero-->
        <div v-if="false"
             class="opacity-60   bg-no-repeat  bg-red   blur-sm   z-0 absolute  bottom-2    start-0 end-0     top-0    "
             :style="`background-image: url(${heroImage});background-size: cover;`">
        </div>
          ...
          <div class="justify-center  px-3  sm:px-1  flex   flex-col md:flex-row items-center">
            ...
            <div
              ...
              <div class="flex   w-full items-center justify-center  ">
                    <span
                        class="absolute animate-pulse mx-auto py-4 flex border w-fit bg-gradient-to-r blur-xl from-amber-200 via-amber-100 to-amber-400 bg-clip-text text-6xl box-content font-extrabold text-transparent text-center select-none">
                    <div class="text-si text-7xl ">Ailverchi</div>
                  <ApplicationLogo class="h-20"></ApplicationLogo>
                  </span>
                <h1
                    class="relative top-0 w-fit h-auto py-4 justify-center flex bg-gradient-to-r items-center from-amber-200 via-amber-100 to-amber-400 bg-clip-text text-6xl font-extrabold text-transparent text-center select-auto">
                  <div class="text-si text-7xl ">Ailverchi</div>
                  <ApplicationLogo class="h-20"></ApplicationLogo>
                </h1>
              </div>
      ...
      <div class="container  mx-auto space-y-4 relative">
        ...
        <section class="flex flex-col slide-in-bottom-h1  justify-center   text-center ">
          <h1 class=" my-4 text-primary-500 mx-auto w-fit text-3xl font-bold border-primary       ">
            {{ $page.props.sections[0].header }}
            <div
...
import heroImage from '@/../images/hero_ae.jpg';
